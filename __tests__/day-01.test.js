const getFuelRequirements = require("../day-01-rocket-equation/FuelRequirements").getFuelRequirements;
const getNewFuelRequirements = require("../day-01-rocket-equation/FuelRequirements").getNewFuelRequirements;
...
*/
describe("Day 01b: Rocket Equation", () => {
   it("Needs 2 units of fuel for a mass of 14", () => {
      expect(getNewFuelRequirements(14)).toBe(2);
   });
   it("Needs 966 units of fuel for a mass of 1969", () => {
      expect(getNewFuelRequirements(1969)).toBe(966);
   });
   it("Needs 50346 units of fuel for a mass of 100756", () => {
      expect(getNewFuelRequirements(100756)).toBe(50346);
   });
});